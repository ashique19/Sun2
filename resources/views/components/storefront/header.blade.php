...
{{-- Outside <header> so position:fixed is viewport-relative; available to guests + auth --}}
<input type="checkbox" id="mobile-nav-toggle" class="mobile-nav-toggle" autocomplete="off">

<div class="mobile-nav-drawer sm:hidden" role="dialog" aria-modal="true" aria-label="{{ __('storefront.menu') }}">
    <label for="mobile-nav-toggle" class="mobile-nav-drawer__backdrop" aria-label="{{ __('storefront.close_menu') }}"></label>
