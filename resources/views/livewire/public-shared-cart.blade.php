<x-storefront.shell>
    <div class="mx-auto max-w-3xl px-4 py-6 sm:px-6">
        ...
        @else
            ...
            @if ($lines->isEmpty())
                <div class="rounded-xl border border-[#EFE7D6] bg-white p-8 text-center">
                    <p class="text-sm text-[#8C8474]">{{ __('storefront.shared_cart_empty') }}</p>
                    <div class="mt-6 flex flex-wrap items-center justify-center gap-3">
                        <a href="{{ route('home') }}" wire:navigate
                           class="inline-block rounded-full bg-[#C9A227] px-6 py-2.5 text-sm font-semibold text-white hover:bg-[#b8931f]">
                            {{ __('storefront.go_home') }}
            ...
            @else
                ...
                <div class="rounded-xl border border-[#EFE7D6] bg-white p-6">
                    ...
                    <button type="button"
                        ...
                        class="block w-full text-center rounded-full bg-[#C9A227] px-8 py-3 text-sm font-semibold text-white hover:bg-[#b8931f] transition disabled:opacity-60">
