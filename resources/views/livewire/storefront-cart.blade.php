    ...
    <div class="mx-auto max-w-6xl px-4 py-8">
        ...
        @if ($lines->isEmpty())
            <div class="rounded-xl border border-dashed border-[#D8CDB6] p-10 text-center">
                <p class="text-[#6B6459] mb-4">Your cart is empty.</p>
        ...
        @else
            <div class="grid lg:grid-cols-3 gap-8">
                    ...
                    @foreach ($lines as $line)
                        ...
                        <div class="flex gap-4 rounded-xl border border-[#EFE7D6] bg-white p-4" wire:key="cart-line-{{ $product->id }}">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm text-[#8C8474] mt-1">&#2547; {{ number_format($product->price, 0) }} each</p>
                                <div class="mt-3 flex flex-wrap items-center gap-3">
                                    ...
                                    <button type="button" wire:click="remove({{ $product->id }})" class="text-sm text-rose-600 hover:underline">Remove</button>
                                </div>
                            </div>
                ...
                <div class="rounded-xl border border-[#EFE7D6] bg-white p-6 h-fit">
                    ...
                    <p class="text-xs text-[#8C8474] mb-4">Delivery &amp; discounts calculated at checkout.</p>
