...
class AdminDashboardLayoutTest extends TestCase
{
    ...
    public function clear_attention_state_renders_a_compact_row(): void
    {
        ...
        Livewire::test(AdminDashboard::class)
            ...
            ->assertSee('DQ')
            ->assertSee('CV')
            ->assertSeeHtml('aria-label="Order quantity (placed that day)"')
            ->assertSeeHtml('aria-label="Order value (placed that day)"')
            ->assertSeeHtml('aria-label="Delivered quantity (of orders placed that day)"')
            ->assertSeeHtml('aria-label="Collected value (of orders placed that day)"')
